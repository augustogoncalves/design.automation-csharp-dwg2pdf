...
namespace webapp.AWS
{
  public class Signature
  {
      ...
      string verb, string absolutePath)
    {
      ...
      byte[] signingKey = GetSignatureKey(Config.AWS_SECRET_KEY, dateStamp, RegionName.SystemName, ServiceName);
      ...
      string authorization = string.Format("{0} Credential={1}/{2}/{3}/{4}/aws4_request, SignedHeaders={5}, Signature={6}",
        Algorithm, Config.AWS_ACCESS_KEY, dateStamp, RegionName.SystemName, ServiceName, SignedHeaders, signature);
